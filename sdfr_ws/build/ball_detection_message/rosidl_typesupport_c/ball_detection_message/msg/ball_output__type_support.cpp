...
static const _BallOutput_type_support_symbol_names_t _BallOutput_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ball_detection_message, msg, BallOutput)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ball_detection_message, msg, BallOutput)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ball_detection_message, msg, BallOutput)() {
  return &::ball_detection_message::msg::rosidl_typesupport_c::BallOutput_message_type_support_handle;
}

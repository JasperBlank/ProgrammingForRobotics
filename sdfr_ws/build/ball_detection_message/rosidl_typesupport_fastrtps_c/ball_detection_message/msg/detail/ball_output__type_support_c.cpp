...
#include "ball_detection_message/msg/detail/ball_output__rosidl_typesupport_fastrtps_c.h"
...
#include "ball_detection_message/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _BallOutput__ros_msg_type = ball_detection_message__msg__BallOutput;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ball_detection_message
size_t get_serialized_size_ball_detection_message__msg__BallOutput(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // field.name x_1
  {
    size_t item_size = sizeof(ros_message->x_1);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name y_1
  {
    size_t item_size = sizeof(ros_message->y_1);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name x_2
  {
    size_t item_size = sizeof(ros_message->x_2);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name y_2
  {
    size_t item_size = sizeof(ros_message->y_2);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name ball_check
...
static uint32_t _BallOutput__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ball_detection_message__msg__BallOutput(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ball_detection_message
size_t max_serialized_size_ball_detection_message__msg__BallOutput(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ball_detection_message__msg__BallOutput;
    is_plain =
      (
...
static size_t _BallOutput__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ball_detection_message__msg__BallOutput(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ball_detection_message, msg, BallOutput)() {

...
bool robot_image_messages__msg__brightness__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_image_messages.msg._brightness.Brightness", full_classname_dest, 47) == 0);
  }
  robot_image_messages__msg__Brightness * ros_message = _ros_message;
  {  // brightness_level
...
PyObject * robot_image_messages__msg__brightness__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_image_messages.msg._brightness");

...
static const _BallOutput_type_support_symbol_names_t _BallOutput_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_image_messages, msg, BallOutput)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robot_image_messages, msg, BallOutput)),
  }
};
...
{
  return &::robot_image_messages::msg::rosidl_typesupport_cpp::BallOutput_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robot_image_messages, msg, BallOutput)() {
  return get_message_type_support_handle<robot_image_messages::msg::BallOutput>();
}

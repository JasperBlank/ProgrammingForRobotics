...
#include "robot_image_messages/msg/detail/brightness__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robot_image_messages::msg::Brightness & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_image_messages::msg::Brightness & ros_message)
{
  // Member: brightness_level
  cdr >> ros_message.brightness_level;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_image_messages::msg::Brightness;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robot_image_messages::msg::Brightness *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_image_messages::msg::Brightness *>(
    untyped_ros_message);
...
{
  return &robot_image_messages::msg::typesupport_fastrtps_cpp::_Brightness__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_image_messages, msg, Brightness)() {
  return &robot_image_messages::msg::typesupport_fastrtps_cpp::_Brightness__handle;
}

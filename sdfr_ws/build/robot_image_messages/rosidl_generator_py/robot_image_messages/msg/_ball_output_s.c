...
bool robot_image_messages__msg__ball_output__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_image_messages.msg._ball_output.BallOutput", full_classname_dest, 48) == 0);
  }
  robot_image_messages__msg__BallOutput * ros_message = _ros_message;
  {  // top_left
    ...
    }
    {
      ...
      Py_ssize_t size = 2;
      int32_t * dest = ros_message->top_left;
  ...
  {  // bottom_right
    ...
    }
    {
      ...
      assert(PyArray_TYPE(seq_field) == NPY_INT32);
      Py_ssize_t size = 2;
      int32_t * dest = ros_message->bottom_right;
      for (Py_ssize_t i = 0; i < size; ++i) {
        int32_t tmp = *(npy_int32 *)PyArray_GETPTR1(seq_field, i);
        memcpy(&dest[i], &tmp, sizeof(int32_t));
      }
...
PyObject * robot_image_messages__msg__ball_output__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_image_messages.msg._ball_output");
  ...
  {  // top_left
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "top_left");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    int32_t * src = &(ros_message->top_left[0]);
    memcpy(dst, src, 2 * sizeof(int32_t));
    Py_DECREF(field);
  }
  {  // bottom_right
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "bottom_right");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    assert(sizeof(npy_int32) == sizeof(int32_t));
    npy_int32 * dst = (npy_int32 *)PyArray_GETPTR1(seq_field, 0);
    int32_t * src = &(ros_message->bottom_right[0]);
    memcpy(dst, src, 2 * sizeof(int32_t));
    Py_DECREF(field);
  }
  {  // ball_check

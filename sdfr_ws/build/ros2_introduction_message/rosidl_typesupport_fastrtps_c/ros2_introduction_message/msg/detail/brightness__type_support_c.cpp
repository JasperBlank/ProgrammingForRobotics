...
#include "ros2_introduction_message/msg/detail/brightness__rosidl_typesupport_fastrtps_c.h"
...
#include "ros2_introduction_message/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Brightness__ros_msg_type = ros2_introduction_message__msg__Brightness;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_introduction_message
size_t get_serialized_size_ros2_introduction_message__msg__Brightness(
  const void * untyped_ros_message,
...
static uint32_t _Brightness__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_introduction_message__msg__Brightness(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_introduction_message
size_t max_serialized_size_ros2_introduction_message__msg__Brightness(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_introduction_message__msg__Brightness;
    is_plain =
      (
...
static size_t _Brightness__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_introduction_message__msg__Brightness(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_introduction_message, msg, Brightness)() {

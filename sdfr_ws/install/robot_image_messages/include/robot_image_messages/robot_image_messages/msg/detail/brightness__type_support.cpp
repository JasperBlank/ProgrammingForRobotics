...
{
  new (message_memory) robot_image_messages::msg::Brightness(_init);
}

void Brightness_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robot_image_messages::msg::Brightness *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Brightness_message_member_array[2] = {
  {
    ...
    offsetof(robot_image_messages::msg::Brightness, brightness_level),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robot_image_messages::msg::Brightness, brightness_classification),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Brightness_message_members = {
  ...
  2,  // number of fields
  sizeof(robot_image_messages::msg::Brightness),
...
{
  return &::robot_image_messages::msg::rosidl_typesupport_introspection_cpp::Brightness_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robot_image_messages, msg, Brightness)() {
  return &::robot_image_messages::msg::rosidl_typesupport_introspection_cpp::Brightness_message_type_support_handle;
}

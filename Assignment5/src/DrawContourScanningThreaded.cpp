...
void DrawContourScanningThreaded::drawContour(float threshold) {
    ...
    for (float yPoint = yTop; yPoint <= yBottom; yPoint++){
        ...
        // this line was generated by chat-GPT, the previous line was:
        // threads.push_back(std::thread(DrawContourScanningThreaded::printRow, &yPoint, threshold));|
        // but we were getting errors, so we asked to chat-GPT what could be the problem.
    }
